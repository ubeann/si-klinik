...
<body>
    ...
    <h1>Form Pendaftaran Pengguna Baru</h1>
    ...
    <form method="POST" action="<?= route('users/register') ?>">
        <div class="form-group">
            ...
            <input class="long" type="text" id="name" name="name" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="long" type="text" id="phone_number" name="phone_number" required>
